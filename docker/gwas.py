...
for i in range (1,len(sys.argv),2):
    if sys.argv[i] == "-x" or sys.argv[i] == "--genotype":
        ...
        print("-a , --mac_min : integer specifiying the minimum minor allele count necassary for a marker to be included. Default a = 1" )
        print("-bs, --batch-size : integer specifiying the number of markers processed at once. Default -bs 500000" )
        print("-p , --perm : single integer specifiying the number of permutations default 1 == no perm ")
